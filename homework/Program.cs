...
WriteArray(array); // Печать исходного массива
if (CheckArray(array) == 1) WriteArray(FormationNewArray(array)); // Условие запуска функции редактирования и вывода нового массива
else Console.WriteLine($"[]"); // Отсутствие требуемых строк в массиве